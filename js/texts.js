const locale = {
    en: {
        ...
        section: {
            about: {
                first: "I have worked exclusively as a programmer and systems analyst since 2014. All my efforts are directed towards the development, success and excellence of my projects.",
                second: "I earned my associate degree in Technology and Analysis and Development of Systems, my bachelor’s degree in Systems Information at Mackenzie Presbyterian University in São Paulo, Brazil and I just got my degree for MBA with concentration in Los Angeles, USA.",
                third: "I love music, cooking and arts in general. What would be life without it?",
            },
            exp: {
                microsoft: {
    ...
    pt: {
        ...
        section: {
            ...
            aw:{
                ...
                vp: "Vice Presidente do comitê de estudantes em "
            }
        }
    }
};
