        ...
        pt: {
            ...
            section: {
                about: {
                    ...
                    second: "Eu obtive meu Diploma de Tecnologo em Analise e Desenvolvimento de Sistemas e meu bacharelado em Sistemas da Informacao pela Universidade Presbiteriana Mackenzie. Atualmente estou realizando meu Mestrado na California Trinity University localizada em Los Angeles, USA.",
                    third: "Ao longo da minha jornada, fui responsavel por organizar varias atividades tais como desenvolvimento de aplicacoes, websites e jogos. Eu amo programar.",
                ...
                exp: {
                    microsoft: {
                        title: "Estagio em Consultoria",
                        date: "Setembro 2015 – Dezembro 2016",
                        rio: {
                            text: "Contribui para obter os requerimentos do projeto junto ao time de Analises, compareci a reunioes nao presenciais com o cliente e ajudei a resolver os problemas dele. Desenvolvemos a aplicacao utilizando a IDE do Visual Studio, HTML5, CSS, Bootstrap, jQuery, JavaScript e C#.",
                            title: "Jogos Olimpicos e Paralimpicos Rio 2016"
                        },
                        iot: {
                            text: "Gerenciei um projeto onde desenvolvemos um prototipo de uma casa inteligente, onde os quartos da casa continham sensores (como o de iluminosidade, por exemplo) e eles eram controlados por uma aplicacao universal (Mobile, Tablet, Desktop, Xbox). Todos os dados foram armazenados no Microsoft Azure e replicados para um Stream Analytics onde o mesmo enviava dados para o Power BI que ajudava a ter uma visao maior dos dados. A partir disso tinhamos varios tipo de analise, como o quanto de energia era consumido, e assim por diante.",
                            title: "IoT Smarthouse"
                        },
                        ack: {
                            text: "Contribui no desenvolvimento de uma Ack Tool para o time de Compliance, utilizando a arquitetura do SharePoitn, onde eles conseguem coletar assinaturas dos Gerentes e Leads da area. Nos utilizamos os servicos do SharePoint junto com o InfoPath para criar os formularios.",
                            title: "Ack Tool"
                        }
                    },
                    brq: {
                        title: "Estagio em Programacao",
                        date: "Maio 2014 – Maio 2015",
                        itau: {
                            text: "Contribui para a atualizacao de uma aplicacao que estava utilizando servidor WebLogic 8 para um WebLogic 11. Trabalhei com a documentacao do sistema, onde era utilizado a linguagem de programacao Vb.Net e todos os tipos de diagrama foram criados.",
                            title: "Banco Itaú"
                        },
                        cielo: {
                            text: "Desenvolvemos um sistema que ajuda os clientes Cielo a criar suas proprias queries. Esse software permite que os vendedores atraves dessa aplicacao consultem suas vendas, o quanto tem a receber, e muitas outras informacoes em um so lugar. Nos utilizamos Java EE, Spring MVC, JSF, Primefaces, Thymeleaf, Bootstrap, WebLogic, WebSphere and IBM Portal. ",
                            title: "Cielo"
                        }
                    }
                },
                edu: {
                    ass: {
                        title: "Tecnologia em Analise e Desenvolvimento de Sistemas",
                        inst: "Universidade Presbiteriana Mackenzie",
                    ...
                    mba: {
                        title: "Mestrado em Sistemas da Informacao",
                        inst: "California Trinity University",
